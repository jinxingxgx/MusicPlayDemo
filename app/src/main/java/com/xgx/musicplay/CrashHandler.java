...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        // 提示用户程序即将退出
        showToast(mContext, "很抱歉，程序异常，" + ex.getMessage());
//        DemoHelper.getInstance().init(mContext);
        ...
        // PendingIntent restartIntent = PendingIntent.getActivity(MyApplication.getInstance().getApplicationContext(), 0, intent, Intent.FLAG_ACTIVITY_NEW_TASK);
        // // 退出程序
        // AlarmManager mgr = (AlarmManager) MyApplication.getInstance().getApplicationContext().getSystemService(Context.ALARM_SERVICE);
